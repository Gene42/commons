...
public class FamilyTableInputAdapterTest
{
    ...
    public void test0() throws Exception {
        ...
        Map<String, List<String>> queryParameters = RequestUtils.getQueryParameters(testURLVisib);
       ...
       // Mockito.when(uriInfo.getQueryParameters()).thenReturn(queryParameters);
        ...
        for (Map.Entry<String, List<String>> entry : RequestUtils.getQueryParameters(testURLVisib).entrySet()) {
            if (entry == null) {
                continue;
            }
